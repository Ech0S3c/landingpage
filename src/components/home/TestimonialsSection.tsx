...
const TestimonialsSection = () => {
  ...
  const [slidesPerView, setSlidesPerView] = useState(3); // Novo estado para responsividade
  
  const testimonials = [
    {
      image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face",
      text: "Com o apoio da Echosec, fui selecionado para o programa de talentos da IBM."
    },
    {
      image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face",
      text: "Depois de treinar com a Echosec, consegui minha primeira vaga como pentester júnior."
    },
    {
      image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face",
      text: "Com as aulas e material de Echosec, consegui participar da DEFCON CTF e chegar à final."
    },
    {
      image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face",
      text: "A Echosec me deu as ferramentas para conseguir minha primeira certificação em cybersec."
    },
    {
      image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face",
      text: "Através das aulas práticas, consegui uma vaga de analista de segurança em uma multinacional."
    }
  ];

  // Detectar tamanho da tela e ajustar slides visíveis
  useEffect(() => {
      ...
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="flex items-center justify-center">
            ...
            <button 
              onClick={prevSlide}
              className="absolute left-2 sm:left-8 z-10 text-white p-2 sm:p-3 rounded-full shadow-lg hover:scale-110 transition-transform duration-300 ease-in-out bg-black/30"
            >
              ...
              >
                {testimonials.map((testimonial, index) => (
                  ...
                  >
                    ...
                    >
                      <div className="pt-16 sm:pt-20 pb-6 sm:pb-8 px-4 sm:px-6 text-center h-full flex flex-col justify-between">
                        <div>
                          <Image 
            ...
            <button 
              onClick={nextSlide}
              className="absolute right-2 sm:right-8 z-10 text-white p-2 sm:p-3 rounded-full shadow-lg hover:scale-110 transition-transform duration-300 ease-in-out bg-black/30"
            >
              <svg className="w-6 h-6 sm:w-10 sm:h-10" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
